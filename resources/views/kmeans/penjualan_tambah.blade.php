...
<div class="row">
	<div class="col-md-12 col-sm-12 ">
		<div class="x_panel">
			...
			<div class="x_content">
				<br />
				<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/tambah_penjualan_simpan" method="post" enctype="multipart/form-data">
					{{csrf_field() }}
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input type="date" required="required" class="form-control " name="tanggal">
						</div>
					</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input type="text" required="required" class="form-control " name="qty">
						</div>
					</div>
